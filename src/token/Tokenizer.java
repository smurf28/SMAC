...
/**
 * This class implements a tokenizer. A tokenizer is used to split a string
 * (user input) in tokens YOU SHOULD NOT CHANGE THIS FILE
 */
public class Tokenizer {
	...
	/**
	 * reads and returns the next token to be read (i.e. the next token is
